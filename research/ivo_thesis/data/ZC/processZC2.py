...
sst.to_netcdf(join(processeddir, f'sst_ZC_{version}2.nc')) # should check if this still works after changing code above
h.to_netcdf(join(processeddir, f'h_ZC_{version}2.nc')) # should check if this still works after changing code above
...
sst_anom.to_netcdf(join(processeddir, f'sst_ZC_{version}_anom2.nc')) # should check if this still works after changing code above

sst['anomaly'] = sst_anom['temperature']

sst.to_netcdf(join(processeddir, f'sst_ZC_{version}_full2.nc')) # should check if this still works after changing code above
